...
public class ConsistentHashingLoadBalanceSelectorTest {

    @Test
    public void testSelect() {
        ProviderService service1 = new ProviderService("service1", "group1", "v1", 1, "address1");
        ProviderService service2 = new ProviderService("service2", "group1", "v1", 1, "address2");
        ProviderService service3 = new ProviderService("service3", "group1", "v1", 1, "address3");
        ProviderService service4 = new ProviderService("service4", "group1", "v1", 1, "address4");
        ...
        ConsistentHashingLoadBalanceSelector selector = new ConsistentHashingLoadBalanceSelector();
